...
- Match types: {"eojeol_initial": 39, "numeral_equivalent": 10, "absent": 5, "substring_only": 1, "phantom_label": 1}
- Strict loss rate (`absent` only): 0.091, utterance bootstrap 95% CI [0.018, 0.190]
- Inclusive loss rate (`absent` plus ambiguous): 0.109
...
| intent_cue | 5 | 0 | 5 | 4 | 0 | 1 | 0.200 |

## Dialect Marking Contrast

- Dialect-marked critical spans: 4, strict loss rate 0.000
- Other critical spans: 51, strict loss rate 0.098
- Difference: -0.098, utterance bootstrap 95% CI [-0.204, -0.019] — excludes zero
