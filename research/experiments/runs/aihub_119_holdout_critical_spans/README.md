...
|---|---:|---:|---:|
| old, substring | 0 | 0 | 0.000 |
| new, eojeol boundary | 93 | 0 | 0.000 |

- Old category counts: {}
- New category counts: {"negation": 48, "confirmation": 42, "date_time": 2, "intent_cue": 1}
- Old phantom labels by category: {}
- New phantom labels by category: {}
