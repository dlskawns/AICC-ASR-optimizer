...
- Match types: {"eojeol_initial": 82, "absent": 11}
- Strict loss rate (`absent` only): 0.118, utterance bootstrap 95% CI [0.053, 0.196]
- Inclusive loss rate (`absent` plus ambiguous): 0.118
...
|---|---:|---:|---:|---:|---:|---:|---:|
| negation | 48 | 0 | 48 | 47 | 0 | 1 | 0.021 |
| confirmation | 42 | 0 | 42 | 32 | 0 | 10 | 0.238 |
| date_time | 2 | 0 | 2 | 2 | 0 | 0 | 0.000 |
| intent_cue | 1 | 0 | 1 | 1 | 0 | 0 | 0.000 |

## Dialect Marking Contrast

- Dialect-marked critical spans: 5, strict loss rate 0.000
- Other critical spans: 88, strict loss rate 0.125
- Difference: -0.125, utterance bootstrap 95% CI [-0.205, -0.057] — excludes zero
