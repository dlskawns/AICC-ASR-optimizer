...
- Match types: {"eojeol_initial": 83, "absent": 10}
- Strict loss rate (`absent` only): 0.108, utterance bootstrap 95% CI [0.044, 0.182]
- Inclusive loss rate (`absent` plus ambiguous): 0.108
...
|---|---:|---:|---:|---:|---:|---:|---:|
| negation | 48 | 0 | 48 | 46 | 0 | 2 | 0.042 |
| confirmation | 42 | 0 | 42 | 34 | 0 | 8 | 0.190 |
...
- Other critical spans: 88, strict loss rate 0.114
- Difference: -0.114, utterance bootstrap 95% CI [-0.191, -0.047] — excludes zero
