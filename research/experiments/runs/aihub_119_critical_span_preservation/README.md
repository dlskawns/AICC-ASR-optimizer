...
- Match types: {"eojeol_initial": 41, "phantom_label": 16, "numeral_equivalent": 10, "absent": 6, "substring_only": 1}
- Strict loss rate (`absent` only): 0.103, utterance bootstrap 95% CI [0.019, 0.203]
- Inclusive loss rate (`absent` plus ambiguous): 0.121
...
|---|---:|---:|---:|---:|---:|---:|---:|
| negation | 17 | 0 | 17 | 15 | 1 | 1 | 0.059 |
| confirmation | 17 | 4 | 13 | 10 | 0 | 3 | 0.231 |
| intent_cue | 15 | 10 | 5 | 4 | 0 | 1 | 0.200 |
| date_time | 13 | 0 | 13 | 12 | 0 | 1 | 0.077 |
| amount | 12 | 2 | 10 | 10 | 0 | 0 | 0.000 |

## Dialect Marking Contrast

- Dialect-marked critical spans: 4, strict loss rate 0.000
- Other critical spans: 54, strict loss rate 0.111
- Difference: -0.111, utterance bootstrap 95% CI [-0.214, -0.020] — excludes zero
